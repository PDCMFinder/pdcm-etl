...
treatment_protocol_several_treatment_several_doses = [
    {
        "id": "1",
        "model_id": "1",
        "patient_id": None,
        "treatment_name": "5-Fluorouracil + Epirubicin + Cyclophosphamide",
        "treatment_type": "treatment",
...
treatment_protocol_one_treatment_one_type = [
    {
        "id": "1",
        "model_id": "1",
        "patient_id": None,
...
treatment_protocol_several_treatment_several_types = [
    {
        "id": "1",
        "model_id": "1",
        "patient_id": None,
        "treatment_name": "5-Fluorouracil + Epirubicin + Cyclophosphamide",
        "treatment_type": "treatment1 + treatment2 + treatment3",
        "treatment_dose": "500 mg/m2 + 75 mg/m2 + 500 mg/m2",
        "treatment_target": "drug dosing",
        "response_id": "1",
        "response_classification_id": "1",
...
treatment_protocol_several_treatments_one_type = [
    {
        "id": "1",
        "model_id": "1",
        "patient_id": None,
