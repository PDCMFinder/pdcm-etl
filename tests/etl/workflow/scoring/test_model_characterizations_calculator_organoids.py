...
def create_model_characterizations_conf_df():
   ...
   """
    ...
    data = [
        (1, "PDX Metadata Characterization", "PDX Metadata Characterization description", "PDX models",
...
def create_search_index_max_in_vitro_score_df():
   ...
   """
    ...
    data = [(
        ...
        json.dumps(empty_xenograft_data),
        ...
        "model_name_aliases_valid_value",
        "growth_properties_valid_value",
        "growth_media_valid_value",
        "media_id_valid_value",
        "plate_coating_valid_value",
        "other_plate_coating_valid_value",
        "passage_number_valid_value",
        "contaminated_valid_value",
        "contamination_details_valid_value",
        "supplements_valid_value",
        "drug_valid_value",
        "drug_concentration_valid_value",
    )]
...
def test_add_scores_column_max_score():
    ...
    scores = {"pdx_metadata_score": 0, "data_score": 100, "in_vitro_metadata_score": 100}
    expected_data = [
        (1, json.dumps(scores))
    ]
...
def test_add_scores_column_no_resources():
    ...
    scores = {"pdx_metadata_score": 0, "data_score": 100, "in_vitro_metadata_score": 90}
    expected_data = [
        (1, json.dumps(scores))
    ]
    expected_df = spark.createDataFrame(expected_data, ["pdcm_model_id", "scores"])
...
def test_add_scores_column_no_data_set():
    ...
    scores = {"pdx_metadata_score": 0, "data_score": 0, "in_vitro_metadata_score": 100}
    expected_data = [
        (1, json.dumps(scores))
    ]
    expected_df = spark.createDataFrame(expected_data, ["pdcm_model_id", "scores"])
