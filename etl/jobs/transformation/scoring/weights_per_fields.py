...
common_weights = {
    ...
    "patient_sample_treated_at_collection": 0,
    "patient_sample_treated_prior_to_collection": 0,
...
pdx_only_weights = {
    ...
    "xenograft_model_specimens.engraftment_sample_state": 0,
