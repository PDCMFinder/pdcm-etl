...
def transform_tissue(raw_sample_df: DataFrame) -> DataFrame:
    tissue_df = get_tumour_type_from_collection_site(raw_sample_df).union(get_primary_type_from_sample(raw_sample_df))
...
def get_tumour_type_from_collection_site(raw_sample_df: DataFrame) -> DataFrame:
