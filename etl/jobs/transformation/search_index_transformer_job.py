...
def main(argv):
    ...
    search_index_molecular_data_df = spark.read.parquet(search_index_molecular_data_parquet_path)
...
def transform_search_index(
    ...
    search_index_df = (
        search_index_df.select(
            ...
            col("treatment_naive_at_collection").alias("patient_sample_treatment_naive_at_collection"),
