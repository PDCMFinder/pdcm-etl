...
ALTER TABLE model_information DROP CONSTRAINT IF EXISTS fk_model_publication_group CASCADE;
ALTER TABLE model_information DROP CONSTRAINT IF EXISTS fk_model_accessibility_group CASCADE;
ALTER TABLE model_information DROP CONSTRAINT IF EXISTS fk_model_contact_people CASCADE;
ALTER TABLE model_information DROP CONSTRAINT IF EXISTS fk_model_contact_form CASCADE;
ALTER TABLE model_information DROP CONSTRAINT IF EXISTS fk_model_source_database CASCADE;
ALTER TABLE cell_model DROP CONSTRAINT IF EXISTS fk_cell_model_model CASCADE;
ALTER TABLE cell_sample DROP CONSTRAINT IF EXISTS fk_cell_sample_model CASCADE;
ALTER TABLE cell_sample DROP CONSTRAINT IF EXISTS fk_cell_sample_platform CASCADE;
...
ALTER TABLE xenograft_model_specimen DROP CONSTRAINT IF EXISTS fk_specimen_engraftment_site CASCADE;
ALTER TABLE xenograft_model_specimen DROP CONSTRAINT IF EXISTS fk_specimen_engraftment_type CASCADE;
ALTER TABLE xenograft_model_specimen DROP CONSTRAINT IF EXISTS fk_specimen_engraftment_sample_type CASCADE;
ALTER TABLE xenograft_model_specimen DROP CONSTRAINT IF EXISTS fk_specimen_engraftment_sample_state CASCADE;
ALTER TABLE xenograft_model_specimen DROP CONSTRAINT IF EXISTS fk_specimen_engraftment_sample_type CASCADE;
ALTER TABLE xenograft_model_specimen DROP CONSTRAINT IF EXISTS fk_specimen_host_strain CASCADE;
