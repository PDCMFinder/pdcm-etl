...
REFRESH MATERIALIZED VIEW details_molecular_data;
REFRESH MATERIALIZED VIEW mutation_data_table;
REFRESH MATERIALIZED VIEW mutation_data_table_columns;
REFRESH MATERIALIZED VIEW expression_data_table;
REFRESH MATERIALIZED VIEW expression_data_table_columns;
REFRESH MATERIALIZED VIEW cytogenetics_data_table;
REFRESH MATERIALIZED VIEW cna_data_table;
REFRESH MATERIALIZED VIEW cna_data_table_columns;
REFRESH MATERIALIZED VIEW models_by_cancer;
REFRESH MATERIALIZED VIEW models_by_mutated_gene;
REFRESH MATERIALIZED VIEW models_by_dataset_availability;
